...
if (isset($_POST['signup'])) {
	...
	if (!$error) {
		if(mysqli_query($connection, "INSERT INTO users(name,email,password,last_login, user_type) VALUES('" . $name . "', '" . $email . "', '" . md5($password) . "',now(), 'General')")) {
			...
			$successmsg = "Successfully Registered! <a href='\Movie DB new\index.php'>Click here to redirect...</a>";
		} else {
		...
		<header class="site-header">
			<div class="container">
				<a href="\Movie DB new\index.php" id="branding">
					<img src="/Movie DB new/images/logo.png" alt="" class="logo">
					<div class="logo-copy">
